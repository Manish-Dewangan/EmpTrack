...
export const inngest = new Inngest({ id: "emp-track" });
...
// Send Email to admin, If admin does't take action on leave application within 24 hours 
...
const attendanceReminderCron = inngest.createFunction(
    ...
    async ({ step }) => {
        ...
        // Step 3: Get employee IDa on approved leave today
                    ...
                    sendEmail({
                        ...
                        body: `
                         <div style="max-width: 600px; font-family: Arial, sans-serif;">
                                ...
                                <br />
                                <p style="font-size: 16px;">Best Regards,</p>
                                <p style="font-size: 16px;"><strong>EmpTrack</strong></p>
                            </div>
