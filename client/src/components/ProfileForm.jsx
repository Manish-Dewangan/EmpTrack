    ...
    return (
        <form onSubmit={handleSubmit} className="card p-5 sm:p-6 mb-6">
            ...
            <h2 className="text-base font-medium text-slate-900 mb-6 pb-4 border-b border-slate-100 flex items-center gap-2">
                <User className="w-5 h-5 text-slate-400" />  Profile Details
            </h2>
            ...
            {message && (
                <div className="bg-emerald-50 text-emerald-700 p-4 rounded-xl text-sm border border-emerald-200 mb-6 flex items-start gap-3">
                    <div className="w-1 h-1.5 rounded-full bg-emerald-500 mt-1.5 shrink-0"/>
                    {message}
                </div>
            )}
            ...
            <div className="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" disabled value={initialData.email} />
                </div>
                ...
                <div className="sm:col-span-2">
                    ...
                    <input disabled className="bg-slate-50 cursor-not-allowed text-slate-400" value={initialData.position} />
                </div>
