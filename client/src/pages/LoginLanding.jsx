  ...
  const portalOptions = [
    {
      ...
      title: "Admin Portal",
      description:
        "Manage employees, attendance, payroll, and organizational settings securely.",
      icon: ShieldIcon,
    },
    {
      to: "/login/employee",
      ...
      description:
        "Access your personal information, attendance records, and payroll details securely.",
      icon: UserIcon,
    },
  ];
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div
        className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 rela
      tive overflow-y-auto min-h-screen"
      >
