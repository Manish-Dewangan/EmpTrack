...
const Leave = () => {
  ...
  const leaveStats = [
    { label: "Sick Leave", count: sickCount, icon: ThermometerIcon },
    { label: "Casual Leave", count: casualCount, icon: UmbrellaIcon },
    { label: "Annual Leave", count: annualCount, icon: PalmtreeIcon },
  ];
